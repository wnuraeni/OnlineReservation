...
<form action="<?php echo base_url();?>manager_gudang/inventori_controller/ubah_inventori/<?php echo $id_barang_inventori?>" method="post" enctype="multipart/form-data">
<?php else : ?>
<form action="<?php echo base_url();?>manager_gudang/inventori_controller/tambah_inventori" method="post" enctype="multipart/form-data">
<?php endif ;?>
    <table>
    ...
    <?php endforeach ;?>
    </select></td><td><a href="<?php echo base_url();?>manager_gudang/inventori_controller/tambah_kategori">Tambah</a></td></tr>
    ...
    <tr><td>Harga sewa:</td><td><input type="text" name="harga_sewa" value="<?php echo empty($inventori) ?'':$inventori[0]->harga_sewa ;?>" <?php echo((!empty($inventori[0]->harga_sewa) && !empty($inventori))?'readonly':'');?>></td></tr>
    
    <?php if($this->uri->segment(3)=='ubah_inventori'):?>
    <tr><td><input type="submit" name="simpan" value="simpan" class="btn"></td><td><a href="<?php echo base_url();?>manager_gudang/inventori_controller" class="btnalt">Back</a></td></tr>
    <?php else :?>
    <tr><td><input type="submit" name="tambah" value="tambah" class="btn"></td><td><a href="<?php echo base_url();?>manager_gudang/inventori_controller" class="btnalt">Back</a></td></tr>
    <?php endif ;?>
    </table>
</form>
