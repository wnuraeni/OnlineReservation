...
<!-- Toolbox dropdown start -->
            ...
            <div id="slider">
                <ul id="sliderContent">
                    ...
                    <li><a href="<?php echo base_url()?>manager_keuangan/index/logout" title="">Log Out</a></li>
...
<!-- Userbox/logged in start -->
            <div id="userbox">
            	<p>Welcome, <?php echo $this->session->userdata('manager_keuanganname');?></p>
                <p><span>You are logged in as <?php echo $this->session->userdata('accessmanager_keuangan');?></span></p>
...
<!-- Main navigation start -->         
            <ul id="nav"> 
                <li>
                    ...
                    <ul class="navigation">
                        <li <?php echo ($this->uri->segment(3)== 'request_barang')?'class="heading selected"':'';?>><a href="<?php echo base_url();?>manager_keuangan/pembelian_controller/request_barang">Request Barang</a></li>
                        <li <?php echo ($this->uri->uri_string()== 'manager_keuangan/pembelian_controller/index')?'class="heading selected"':'';?>><a href="<?php echo base_url();?>manager_keuangan/pembelian_controller/index">Data Pembelian</a></li>
                        <li <?php echo ($this->uri->uri_string()== 'manager_keuangan/harga_controller/index')?'class="heading selected"':'';?>><a href="<?php echo base_url();?>manager_keuangan/harga_controller/index">Harga Rekomendasi</a></li>
                      <!--   <li><a href="<?php echo base_url();?>manager_keuangan/harga_controller/salvage">Set Salvage Value</a></li> -->
                         <li <?php echo ($this->uri->uri_string()=='manager_keuangan/inventori_controller/index')? 'class="heading selected"' : '';?>><a href="<?php echo base_url();?>manager_keuangan/inventori_controller/index">Set Harga Barang Inventori</a></li>
                         <li <?php echo ($this->uri->uri_string()== 'manager_keuangan/harga_controller/lapangan')?'class="heading selected"':'';?>><a href="<?php echo base_url();?>manager_keuangan/harga_controller/lapangan">Set Harga Lapangan</a></li>
                         <li <?php echo ($this->uri->uri_string()== 'manager_keuangan/promosi_controller/index')?'class="heading selected"':'';?>><a href="<?php echo base_url();?>manager_keuangan/promosi_controller/index">Set Promosi</a></li>
