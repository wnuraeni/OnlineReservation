...
//if ( !defined('BASEPATH')) exit ('No direct script access.');
 ...
 class reservasi_controller_old extends CI_Controller{
     var $time;
     var $times;
 ...
 function book($jam=null,$tanggal=null,$nama_lapangan=null){
         ...
         $this->form_validation->set_rules('lama_sewa','lama sewa','required|xss_clean');
         $this->form_validation->set_rules('username','lama sewa','callback_cekusername');
         ...
         if($this->form_validation->run() == true){
            ...
            $data_pelanggan = array(
             ...
             $data_booking = array('id_member'=>$id_member,
     ...
     function validasi_totaljampemesanan($nama=null,$alamat=null,$telepon=null,$lamapakai=null,$tanggal=null){
        //get total lama pemakaian
        $where = array('nama'=>$nama,'alamat'=>$alamat,'telepon'=>$telepon,'tanggal_booking'=>$tanggal);
 ...
 function checkin($id_booking){
    ...
    $data_reservasi=$this->reservasi_model->ambil_reservasi(array('id_booking'=>$id_booking));
     ...
     $store2db=array('id_member'=>$data_reservasi[0]->id_member,
